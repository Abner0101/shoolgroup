...
class Request
{
    ...
    public function method($method = false)
    {
        if (true === $method) {
            ...
            // Log::record('[ $_SERVER ] ' . var_export($_SERVER, true), '_SERVER');
            // Log::record('[ $this->server ] ' . var_export($this->server, true), 'this->server');
            if (isset($_POST[Config::get('var_method')])) {
                ...
                $this->method = strtoupper($_SERVER['HTTP_ACCESS_CONTROL_REQUEST_METHOD']);
            } else {
